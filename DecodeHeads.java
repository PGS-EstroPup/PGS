...
public class DecodeHeads {
    public static void main(String[] args) {
        ...
        Pattern pattern = Pattern.compile("https?://textures\\.minecraft\\.net/texture/([a-zA-Z0-9]+)");

        for (String base64 : heads) {
            try {
                ...
                if (matcher.find()) {
                    ...
                    System.out.println("// Failed to find URL in: " + decoded);
                }
            } catch (Exception e) {
